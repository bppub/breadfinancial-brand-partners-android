...
class BreadPartnerDefaults private constructor() {
    companion object {
        ...
        // Default relative scale applied to superscript (<sup>) text rendered inside the popup.
        // A value of 0.5 renders superscript at half of the surrounding text size.
        const val SUPERSCRIPT_TEXT_SCALE = 0.75f
    }
